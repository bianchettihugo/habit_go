...
extension ReminderModelQuerySortThenBy
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }
...
extension ReminderModelQueryWhereDistinct
  ...
  QueryBuilder<ReminderModel, ReminderModel, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderModelQueryProperty
  ...
  QueryBuilder<ReminderModel, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
