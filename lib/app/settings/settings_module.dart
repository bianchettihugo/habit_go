...
class SettingsModule {
  static void init() {
    ...
    Dependency.register<GetSettingsUsecase>(
      GetSettingsUsecaseImpl(repository: Dependency.get<SettingsRepository>()),
    );

    Dependency.register<SaveSettingsUsecase>(
      SaveSettingsUsecaseImpl(repository: Dependency.get<SettingsRepository>()),
    );

    Dependency.registerLazy(
      SettingsCubit(const SettingsEntity()),
    );
  }
}
